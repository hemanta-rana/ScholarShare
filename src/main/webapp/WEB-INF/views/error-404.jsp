...
<head>
    ...
    <title>404 — Page Not Found | ScholarShare</title>
...
<body class="error-page">
    ...
    <main class="error-main">
        ...
        <div class="error-ghost-code" aria-hidden="true">404</div>

        <div class="error-card">

            <%-- Status pill --%>
            <div class="error-status-pill error-status-pill--404">
            ...
            <p class="error-description">
                The academic resource or page you requested could not be located
                in our repository. It may have been moved, removed, or the
                address may have been entered incorrectly.
            </p>

            <%-- Action buttons --%>
            <div class="error-actions">
                <a href="${pageContext.request.contextPath}/browser" class="error-btn-primary">
                    Browse Repository
                </a>
            ...
            <p class="error-diagnostic" style="margin-top:32px;">
                Diagnostic Reference: HTTP_404_RESOURCE_NOT_FOUND_SCHLR
            </p>
